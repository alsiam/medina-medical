...
const Footer = () => {
    return (
        <div className="bg-gray mt-10">
            <div className="container  p-4 mx-auto text-left">
                <div className="grid lg:grid-cols-3">
                    ...
                    <div className="p-4">
                        ...
                        <p className="text-light font-sm my-2">So, we Already told about us in the top on this page we are <span className="text-primary font-semibold">MEDINA MEDICAL</span> Team so if you want to read more about us just click this button below.</p>
            ...
            <p className="text-light">&copy; all rights are reserved by <span className="text-primary font-semibold">MEDINA MEDICAL</span> </p>
        </div>
    );
};
