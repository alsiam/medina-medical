        ...
        <div className="banner-container h-screen">
            <div className="container w-11/12 mx-auto pt-32 text-left">
                <div className="custom">
                      ...
                      <p className="lg:w-3/6 py-4">Hey There Welcome ! It's a pleasure to see you in our webpage. We are <span className="text-primary font-semibold">MEDINA</span> Hospital. We served the best medical treatment , and we try to give the level best from us !</p>
